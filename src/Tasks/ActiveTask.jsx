    ...
    return(
        <div className='flex-shrink-0 h-full w-[300px] p-6 bg-white/80 backdrop-blur-sm rounded-xl border border-white/20 shadow-lg hover:shadow-xl transition-all duration-200'>
            ...
            <div className='mt-auto flex justify-between gap-3'>
                <button className='flex-1 bg-purple-600 hover:bg-purple-700 text-white py-2 px-4 text-sm rounded-lg shadow-md hover:shadow-lg transition-all duration-200'>Mark as Completed</button>
                <button className='flex-1 bg-indigo-600 hover:bg-indigo-700 text-white py-2 px-4 text-sm rounded-lg shadow-md hover:shadow-lg transition-all duration-200'>Mark as Failed</button>
            </div>
        </div>
    )
}
